...
def parse_warnings(input_dir):
    ...
    output_dir = os.path.normpath(input_dir + '/vatt_output')
    ...
    for input_file in input_files:
        ...
        output_file = (output_dir + '/' + datetime.datetime.utcnow().strftime("%m-%d-%Y") + '_' +
                       os.path.basename(input_file).replace('.scrub', '') + '.csv')
