...
The sources for scrub can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/nasa/scrub
.. _tarball: https://github.com/nasa/scrub/archive/master.tar.gz
